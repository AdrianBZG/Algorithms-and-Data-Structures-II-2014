...
void complejo_t::imprime_complejo(ostream& os)
{
	char aux[80];
...
void complejo_t::escribe_complejo(istream& is)
{
	REAL aux1, aux2;
	system("clear");		
...
REAL complejo_t::get_real(void)
{
	return r_.mostrar();
}

REAL complejo_t::get_imag(void)
{
	return i_.mostrar();
}

REAL complejo_t::get_modulo(void)
{
	return sqrt(r_.mostrar()*r_.mostrar()+i_.mostrar()*i_.mostrar());	
}

REAL complejo_t::get_fase(void)
{
